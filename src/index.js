...
export default function createConfig({ styleGuide = 'default', // default | airbnb | typescript | standard
    ...
    switch (`${styleGuide}-${language}`) {
        case 'default-javascript':
            eslintConfig.extends.push('eslint:recommended', 'eslint-plugin-react', 'eslint-plugin-react-hooks', 'eslint-plugin-react-refresh');
        ...
        case 'default-typescript':
            eslintConfig.extends.push('eslint:recommended', 'plugin:@typescript-eslint/recommended',
